...
teacher_model_name = "kamalkraj/BioSimCSE-BioLinkBERT-BASE"  # Our monolingual teacher model, we want to convert to multiple languages
...
num_epochs = 5  # T rain for x epochs
